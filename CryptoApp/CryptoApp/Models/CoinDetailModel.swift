...
URL: https://api.coingecko.com/api/v3/coins/bitcoin?localization=false&tickers=false&market_data=false&community_data=false&developer_data=false&sparkline=false
 ...
 JSON Response :
 {
   ...
   "sentiment_votes_up_percentage": 84.15,
   "sentiment_votes_down_percentage": 15.85,
   "watchlist_portfolio_users": 1525968,
   "market_cap_rank": 1,
   "status_updates": [],
   "last_updated": "2024-03-25T06:21:17.238Z"
 }
...
struct CoinDetailModel: Codable {
    ...
    var readableDescription: String? {
        return description?.en?.stripOutHtml()
    }
}
